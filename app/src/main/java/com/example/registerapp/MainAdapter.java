...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    String url = "https://5fd57d5466125e001650052e.mockapi.io/api/v1/user";
    ...
    private ArrayList<User> getAllUser(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, "https://5fd57d5466125e001650052e.mockapi.io/api/v1/user", null, new Response.Listener<JSONArray>() {
            @Override
